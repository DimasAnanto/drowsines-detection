...
classes = ['Closed', 'Open']
face_cascade = cv2.CascadeClassifier("src/data/haarcascade_frontalface_default.xml")
left_eye_cascade = cv2.CascadeClassifier("src/data/haarcascade_lefteye_2splits.xml")
right_eye_cascade = cv2.CascadeClassifier("src/data/haarcascade_righteye_2splits.xml")
cap = cv2.VideoCapture(0)
model = load_model("src/model.h5")
count = 0
alarm_on = False
alarm_sound = "src/data/alarm.mp3"
status1 = ''
status2 = ''
